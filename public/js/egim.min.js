...
h/=6;}
return[h,s,l];}
function charcountupdate(str){var lng=str.length;var lng2=(str.split(" ").length-1);if(lng==0){var lng3=0;}else{var lng3=str.trim().split(/\s+/).length}
document.getElementById("charcount").innerHTML=lng-lng2;document.getElementById("wordcount").innerHTML=lng3;document.getElementById("spaceCount").innerHTML=lng2;}
...
function boradcreate(){if($("#lefttop").is(':focus')){var lefttop=document.getElementById("lefttop").value;document.getElementById("rlt").value=lefttop;}else{var lefttop=document.getElementById("rlt").value;document.getElementById("lefttop").value=lefttop;}
if($("#righttop").is(':focus')){var righttop=document.getElementById("righttop").value;document.getElementById("rrt").value=righttop;}else{var righttop=document.getElementById("rrt").value;document.getElementById("righttop").value=righttop;}
if($("#leftbottom").is(':focus')){var leftbottom=document.getElementById("leftbottom").value;document.getElementById("rlb").value=leftbottom;}else{var leftbottom=document.getElementById("rlb").value;document.getElementById("leftbottom").value=leftbottom;}
if($("#rightbottom").is(':focus')){var rightbottom=document.getElementById("rightbottom").value;document.getElementById("rrb").value=rightbottom;}else{var rightbottom=document.getElementById("rrb").value;document.getElementById("rightbottom").value=rightbottom;}
document.getElementById("borad-result").innerHTML=".example-div{"+"<br>"+"border-radius: "+lefttop+"px "+righttop+"px "+leftbottom+"px "+rightbottom+"px;"+"<br>"+"-moz-border-radius: "+lefttop+"px "+righttop+"px "+leftbottom+"px "+rightbottom+"px;"+"<br>"+"-webkit-border-radius: "+lefttop+"px "+righttop+"px "+leftbottom+"px "+rightbottom+"px;"+"<br>"+"}";document.getElementById("boradstyle").innerHTML=".sdwpic, .shaddow-div{border-radius: "+lefttop+"px "+righttop+"px "+leftbottom+"px "+rightbottom+"px; -moz-border-radius: "+lefttop+"px "+righttop+"px "+leftbottom+"px "+rightbottom+"px; -webkit-border-radius: "+lefttop+"px "+righttop+"px "+leftbottom+"px "+rightbottom+"px;}";}
function allboradcreate(){if($("#allcorns").is(':focus')){var allcorns=document.getElementById("allcorns").value;document.getElementById("alcrs").value=allcorns;}else{var allcorns=document.getElementById("alcrs").value;document.getElementById("allcorns").value=allcorns;}
document.getElementById("lefttop").value=allcorns;document.getElementById("righttop").value=allcorns;document.getElementById("leftbottom").value=allcorns;document.getElementById("rightbottom").value=allcorns;document.getElementById("rlt").value=allcorns;document.getElementById("rrt").value=allcorns;document.getElementById("rlb").value=allcorns;document.getElementById("rrb").value=allcorns;document.getElementById("borad-result").innerHTML=".example-div{"+"<br>"+"border-radius: "+allcorns+"px "+allcorns+"px "+allcorns+"px "+allcorns+"px;"+"<br>"+"-moz-border-radius: "+allcorns+"px "+allcorns+"px "+allcorns+"px "+allcorns+"px;"+"<br>"+"-webkit-border-radius: "+allcorns+"px "+allcorns+"px "+allcorns+"px "+allcorns+"px;"+"<br>"+"}";document.getElementById("boradstyle").innerHTML=".sdwpic, .shaddow-div{border-radius: "+allcorns+"px "+allcorns+"px "+allcorns+"px "+allcorns+"px; -moz-border-radius: "+allcorns+"px "+allcorns+"px "+allcorns+"px "+allcorns+"px; -webkit-border-radius: "+allcorns+"px "+allcorns+"px "+allcorns+"px "+allcorns+"px;}";}
function Sdw_function(){if(document.getElementById('inset').checked){inset=document.getElementById('inset').value;}else if(document.getElementById('outline').checked){inset='';}
var high=document.getElementById("high").value;var shwcolor1=document.getElementById("shw-color").value;var left=document.getElementById("left").value;var rad=document.getElementById("rad").value;var blur=document.getElementById("blur").value;var op2=document.getElementById("opacity").value;var op=(op2/100);document.getElementById("high-res").value=high;document.getElementById("left-res").value=left;document.getElementById("rad-res").value=rad;document.getElementById("blur-res").value=blur;document.getElementById("opac-res").value=op;var g=hexToRgb(shwcolor1).g;var b=hexToRgb(shwcolor1).b;var r=hexToRgb(shwcolor1).r;document.getElementById("sdw-result").innerHTML=".shaddow-div{-webkit-box-shadow: "+inset+" "+high+"px "+left+"px "+blur+"px "+rad+"px "+"rgba("+r+","+g+","+b+","+op+");"+";-moz-box-shadow: "+inset+" "+high+"px "+left+"px "+blur+"px "+rad+"px "+"rgba("+r+","+g+","+b+","+op+");"+";box-shadow: "+inset+" "+high+"px "+left+"px "+blur+"px "+rad+"px "+"rgba("+r+","+g+","+b+","+op+");"+";}";document.getElementById("sdw-result-div").innerHTML=".shadow-div{"+"<br>"+"-webkit-box-shadow: "+inset+" "+high+"px "+left+"px "+blur+"px "+rad+"px "+"rgba("+r+","+g+","+b+","+op+");"+"<br>"+"-moz-box-shadow: "+inset+" "+high+"px "+left+"px "+blur+"px "+rad+"px "+"rgba("+r+","+g+","+b+","+op+");"+"<br>"+"box-shadow: "+inset+" "+high+"px "+left+"px "+blur+"px "+rad+"px "+"rgba("+r+","+g+","+b+","+op+");"+"<br>"+"}";}
function btn_function(){var btnborder=document.getElementById("btnborder").value;var btnfontsize=document.getElementById("btnfontsize").value;var btnradius=document.getElementById("btnradius").value;var btncolor=document.getElementById("btncolor").value;var btn_txt_color=document.getElementById("btn_txt_color").value;var btn_border_color=document.getElementById("btn_border_color").value;document.getElementById("rresult").value=btnradius;document.getElementById("fresult").value=btnfontsize;document.getElementById("bbresult").value=btnborder;document.getElementById("btn-result").innerHTML=".my-button{border-radius: "+btnradius+"px;background-color: "+btncolor+"; border: "+btnborder+"px solid "+btn_border_color+";color: "+btn_txt_color+";padding: 15px 32px;text-align: center;text-decoration: none;display: inline-block;font-size: "+btnfontsize+"px;}";document.getElementById("btn-result-div").innerHTML=".my-button{ "+"<br>"+"border-radius:"+btnradius+"px; "+"<br>"+"background-color: "+btncolor+"; "+"<br>"+"border: "+btnborder+"px solid "+btn_border_color+";"+"<br>"+"color: "+btn_txt_color+";"+"<br>"+"padding: 15px 32px;"+"<br>"+"text-align: center;"+"<br>"+"text-decoration: none;"+"<br>"+"display: inline-block;"+"<br>"+"font-size: "+btnfontsize+"px; "+"<br>"+"}";}
function btn_function2(){var btncolor=document.getElementById("btncolor").value;var btn_txt_color=document.getElementById("btn_txt_color").value;var btn_border_color=document.getElementById("btn_border_color").value;if(document.getElementById("bbresult").value<=20&&document.getElementById("bbresult").value>=0){var btnborder=document.getElementById("bbresult").value;}else{var btnborder=0}
if(document.getElementById("fresult").value<=50&&document.getElementById("fresult").value>=1){var btnfontsize=document.getElementById("fresult").value;}else{var btnfontsize=0}
if(document.getElementById("rresult").value<=50&&document.getElementById("rresult").value>=1){var btnradius=document.getElementById("rresult").value;}else{var btnradius=0}
document.getElementById("btnradius").value=btnradius;document.getElementById("btnfontsize").value=btnfontsize;document.getElementById("btnborder").value=btnborder;document.getElementById("btn-result").innerHTML=".my-button{border-radius: "+btnradius+"px;background-color: "+btncolor+"; border: "+btnborder+"px solid "+btn_border_color+";color: "+btn_txt_color+";padding: 15px 32px;text-align: center;text-decoration: none;display: inline-block;font-size: "+btnfontsize+"px;}";document.getElementById("btn-result-div").innerHTML=".my-button{ "+"<br>"+"border-radius:"+btnradius+"px; "+"<br>"+"background-color: "+btncolor+"; "+"<br>"+"border: "+btnborder+"px solid "+btn_border_color+";"+"<br>"+"color: "+btn_txt_color+";"+"<br>"+"padding: 15px 32px;"+"<br>"+"text-align: center;"+"<br>"+"text-decoration: none;"+"<br>"+"display: inline-block;"+"<br>"+"font-size: "+btnfontsize+"px; "+"<br>"+"}";}
function resetcssminfunction(){document.getElementById('css_text').value="";document.getElementById("mincharcount").innerHTML="0";}
function copycssminified(){let textarea=document.getElementById("css_text");textarea.select();document.execCommand("copy");$("#copiedmincss").css('display','').delay(3000).fadeOut();}
function cpikcer_code_copy(){let input=document.getElementById("rgbres");input.select();document.execCommand("copy");$("#hex_copied").css('display','none');$("#hsla_copied").css('display','none');$("#rgb_copied").css('display','').delay(3000).fadeOut();}
function hcpikcer_code_copy(){let input=document.getElementById("hslres");input.select();document.execCommand("copy");$("#hex_copied").css('display','none');$("#rgb_copied").css('display','none');$("#hsla_copied").css('display','').delay(3000).fadeOut();}
function hexcpikcer_code_copy(){let input=document.getElementById("hexres");input.select();document.execCommand("copy");$("#hsla_copied").css('display','none');$("#rgb_copied").css('display','none');$("#hex_copied").css('display','').delay(3000).fadeOut();}
function copyhexcode(){let input=document.getElementById("hex");input.select();document.execCommand("copy");$("#rgbcopied").css('display','none').delay(3000).fadeOut();$("#hslcopied").css('display','none').delay(3000).fadeOut();$("#hexcopied").css('display','').delay(3000).fadeOut();}
function copyhlscode(){let input=document.getElementById("hsl");input.select();document.execCommand("copy");$("#hexcopied").css('display','none').delay(3000).fadeOut();$("#rgbcopied").css('display','none').delay(3000).fadeOut();$("#hslcopied").css('display','').delay(3000).fadeOut();}function copyrgbcode(){let input=document.getElementById("rgb");input.select();document.execCommand("copy");$("#hslcopied").css('display','none').delay(3000).fadeOut();$("#hexcopied").css('display','none').delay(3000).fadeOut();$("#rgbcopied").css('display','').delay(3000).fadeOut();}
function copypassword(){let input=document.getElementById("pssgnt");input.select();document.execCommand("copy");$("#copiedpass").css('display','').delay(3000).fadeOut();}
function cssminify_function(){var minifyres=document.getElementById("css_text").value;$("#minifierform")[0].reset();text=minifyres.replace(/\/\*(.|[\r\n])*?\*\//g,"");t=text.replace(/\r?\n|\r/g,"").replace(/  /g," ");text2=t.replace(/{  /g,"{").replace(/{ /g,"{").replace(/;  /g,";").replace(/; /g,";").replace(/  /g," ");document.getElementById("css_text").innerHTML=text2;var lng1=text2.length;document.getElementById("mincharcount").innerHTML=lng1;}
function uncssminify_function(){var minifyres=document.getElementById("css_text").value;$("#minifierform")[0].reset();text=minifyres.replace(/\/\*(.|[\r\n])*?\*\//g,"");t=text.replace(/\r?\n|\r/g,"").replace(/  /g," ");t2=t.replace(/{  /g,"{").replace(/{ /g,"{").replace(/;  /g,";").replace(/; /g,";").replace(/  /g," ");text2=t.replace(/{/g,"{\n   ").replace(/;/g,";\n   ").replace(/}/g,"\n}\n");document.getElementById("css_text").innerHTML=text2;var lng1=text2.length;document.getElementById("mincharcount").innerHTML=lng1;}
function csscommcleaner(){var minifyres=document.getElementById("css_text").value;$("#minifierform")[0].reset();text=minifyres.replace(/\/\*(.|[\r\n])*?\*\//g,"").replace(/\n\s*\n/g,'\n');document.getElementById("css_text").innerHTML=text;document.getElementById("mincharcount").innerHTML=text.length;}
function text_maker(){var textclr=document.getElementById("textclr").value;var shwcolor=document.getElementById("shwcolor").value;var fontfam=document.getElementById("fontfam").value;var textdoc=document.getElementById("textdoc").value;var txttrans=document.getElementById("txttrans").value;var fontstyle=document.getElementById("fontstyle").value;var fontweight=document.getElementById("fontweight").value;var text=document.getElementById("text").value;var fdr=document.getElementById("fontdirection").value;if($("#fntsize").is(':focus')){var fntsize=document.getElementById("fntsize").value;document.getElementById("rfntsize").value=fntsize;}else{var fntsize=document.getElementById("rfntsize").value;document.getElementById("fntsize").value=fntsize;}
if($("#ltrspc").is(':focus')){var ltrspc=document.getElementById("ltrspc").value;document.getElementById("rltrspc").value=ltrspc;}else{var ltrspc=document.getElementById("rltrspc").value;document.getElementById("ltrspc").value=ltrspc;}
if($("#wrdspc").is(':focus')){var wrdspc=document.getElementById("wrdspc").value;document.getElementById("rwrdspc").value=wrdspc;}else{var wrdspc=document.getElementById("rwrdspc").value;document.getElementById("wrdspc").value=wrdspc;}
if($("#sdwhor").is(':focus')){var sdwhor=document.getElementById("sdwhor").value;document.getElementById("rsdwhor").value=sdwhor;}else{var sdwhor=document.getElementById("rsdwhor").value;document.getElementById("sdwhor").value=sdwhor;}
if($("#sdwver").is(':focus')){var sdwver=document.getElementById("sdwver").value;document.getElementById("rsdwver").value=sdwver;}else{var sdwver=document.getElementById("rsdwver").value;document.getElementById("sdwver").value=sdwver;}
if($("#sdwblr").is(':focus')){var sdwblr=document.getElementById("sdwblr").value;document.getElementById("rsdwblr").value=sdwblr;}else{var sdwblr=document.getElementById("rsdwblr").value;document.getElementById("sdwblr").value=sdwblr;}
document.getElementById("texthere").innerHTML=text;document.getElementById("glink").href="https://fonts.googleapis.com/css?family="+fontfam+"";document.getElementById("goog-link").innerHTML="link href='https://fonts.googleapis.com/css?family="+fontfam+"'"
document.getElementById("textstyle").innerHTML=".example-text{ font-family: '"+fontfam+"'; font-style: "+fontstyle+"; font-weight: "+fontweight+"; color: "+textclr+"; font-size: "+fntsize+"px; text-decoration: "+textdoc+"; text-transform: "+txttrans+"; letter-spacing: "+ltrspc+"px; direction: "+fdr+"; word-spacing: "+wrdspc+"px; text-shadow: "+sdwver+"px "+sdwhor+"px "+sdwblr+"px "+shwcolor+";}";document.getElementById("font-result").innerHTML=".example-text{"+"<br>"+" font-family: '"+fontfam+"'; "+"<br>"+" font-style: "+fontstyle+"; "+"<br>"+" font-weight: "+fontweight+"; "+"<br>"+" color: "+textclr+"; "+"<br>"+" font-size: "+fntsize+"px; "+"<br>"+" text-decoration: "+textdoc+"; "+"<br>"+" text-transform: "+txttrans+"; "+"<br>"+" letter-spacing: "+ltrspc+"px; "+"<br>"+" direction: "+fdr+"; "+"<br>"+" word-spacing: "+wrdspc+"px; "+"<br>"+" text-shadow: "+sdwver+"px "+sdwhor+"px "+sdwblr+"px "+shwcolor+";"+"<br>"+" }";}
function minifiedcharcount(str){var lng1=str.length;document.getElementById("mincharcount").innerHTML=lng1;}
function slug(str,sepin){str=str.replace("ə",'e').replace("ş",'sh').replace("ç",'ch').replace("ı",'i');str=str.replace(/^\s+|\s+$/g,'');str=str.toLowerCase();var from="ãàáäâẽèéëêìíïîõòóöôùúüûñç·/_,:;";var to="aaaaaeeeeeiiiiooooouuuunc------";for(var i=0,l=from.length;i<l;i++){str=str.replace(new RegExp(from.charAt(i),'g'),to.charAt(i));}
str=str.replace(/[^a-z0-9 -]/g,'').replace(/\s+/g,sepin).replace(/-+/g,sepin);return str;};function make_slug_func(){var slugin=document.getElementById("slugin").value;var sepin=document.getElementById("sepin").value;var result=slug(slugin,sepin);document.getElementById("slugin").value=result;}
function resetaprcalculation(){document.getElementById('apr').value="";document.getElementById('amount').value="";$("#resulttable").css('display','none');$("#success").css('display','none');$(".fail-func").css('display','none');$("#reseted").css('display','');}
function pvcalculatorreset(){document.getElementById('rate').value="";document.getElementById('amount').value="";document.getElementById('time').value="";$("#resulttable").css('display','none');$("#success").css('display','none');$(".fail-func").css('display','none');$("#reseted").css('display','');}
function number_format(number,decimals,dec_point,thousands_sep){number=(number+'').replace(/[^0-9+\-Ee.]/g,'');var n=!isFinite(+number)?0:+number,prec=!isFinite(+decimals)?0:Math.abs(decimals),sep=(typeof thousands_sep==='undefined')?',':thousands_sep,dec=(typeof dec_point==='undefined')?'.':dec_point,s='',toFixedFix=function(n,prec){var k=Math.pow(10,prec);return''+Math.round(n*k)/k;};s=(prec?toFixedFix(n,prec):''+Math.round(n)).split('.');if(s[0].length>3){s[0]=s[0].replace(/\B(?=(?:\d{3})+(?!\d))/g,sep);}
if((s[1]||'').length<prec){s[1]=s[1]||'';s[1]+=new Array(prec-s[1].length+1).join('0');}
return s.join(dec);}
function apr_calc_function(file,delete_after=false){var apr=document.getElementById("apr").value;var amount=document.getElementById("amount").value;var month=document.getElementById("month").value;var curr=document.getElementById("curr").value;$("#resulttable").css('display','');document.getElementById("apr-calc-result").innerHTML=number_format((((apr/100/12)*amount)/(1-(Math.pow((1+(apr/100/12)),-month))))*month,2)+" "+curr;document.getElementById("loan-month").innerHTML=month;document.getElementById("loan-monthly").innerHTML=number_format(((apr/100/12)*amount)/(1-(Math.pow((1+(apr/100/12)),-month))),2)+" "+curr;document.getElementById("loan-yearly").innerHTML=number_format(((apr/100/12)*amount)*12/(1-(Math.pow((1+(apr/100/12)),-month))),2)+" "+curr;document.getElementById("loan-differ").innerHTML=number_format((((apr/100/12)*amount)/(1-(Math.pow((1+(apr/100/12)),-month))))*month-amount,2)+" "+curr;}
function pvcalculate(file,delete_after=false){var rate=document.getElementById("rate").value/100;var amount=document.getElementById("amount").value;var time=document.getElementById("time").value;var curr=document.getElementById("curr").value;$("#resulttable").css('display','');document.getElementById("pvresult").innerHTML=number_format(amount/(Math.pow((1+rate),time)),2)+' '+curr;}
function fvcalculate(file,delete_after=false){var rate=document.getElementById("rate").value/100;var amount=document.getElementById("amount").value;var time=document.getElementById("time").value;var curr=document.getElementById("curr").value;$("#resulttable").css('display','');document.getElementById("fvresult").innerHTML=number_format(amount*(Math.pow((1+rate),time)),2)+' '+curr;}
function calculatemanually(){apr_calc_function();var apr=document.getElementById("apr").value;var amount=document.getElementById("amount").value;if(apr===""||amount===""){$("#reseted").css('display','none');$("#success").css('display','none');$(".fail-func").css('display','').delay(3000).fadeOut();}else{$("#reseted").css('display','none');$(".fail-func").css('display','none');$("#success").css('display','').delay(3000).fadeOut();}}
function pvcalcman(){pvcalculate();var apr=document.getElementById("rate").value;var amount=document.getElementById("amount").value;var time=document.getElementById("time").value;if(apr===""||amount===""||time===""){$("#reseted").css('display','none');$("#success").css('display','none');$(".fail-func").css('display','').delay(3000).fadeOut();}else{$("#reseted").css('display','none');$(".fail-func").css('display','none');$("#success").css('display','').delay(3000).fadeOut();}}
function fvcalcman(){fvcalculate();var apr=document.getElementById("rate").value;var amount=document.getElementById("amount").value;var time=document.getElementById("time").value;if(apr===""||amount===""||time===""){$("#reseted").css('display','none');$("#success").css('display','none');$(".fail-func").css('display','').delay(3000).fadeOut();}else{$("#reseted").css('display','none');$(".fail-func").css('display','none');$("#success").css('display','').delay(3000).fadeOut();}}
function generatepwd(file,delete_after=false){if($("#pssgntnmb").is(':focus')){var numb=document.getElementById("pssgntnmb").value;document.getElementById("rpssgntnmb").value=numb;}else{var numb=document.getElementById("rpssgntnmb").value;document.getElementById("pssgntnmb").value=numb;}
var text='';if(document.getElementById('pwd3').checked){var p1="!#$%&'()*+,-./:;<=>?@[]^_`{|}~";}else{var p1='';}if(document.getElementById('pwd2').checked){var p2="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";}else{var p2='';}if(document.getElementById('pwd1').checked){var p3="0123456789";}else{var p3='0';}
var possible=p1+p2+p3;for(var i=0;i<numb;i++){text+=possible.charAt(Math.floor(Math.random()*possible.length));}
document.getElementById("pssgnt").value=text;}
if(window.location.href.match('/password-generator')!=null){window.onload=function(){generatepwd(numb=8);};}
$(document).ready(function(){$("#Searchtools").on("keyup",function(){var value=$(this).val().toLowerCase();$("#Searchtls tr").filter(function(){$(this).toggle($(this).text().toLowerCase().indexOf(value)>-1)});});});function rotate_div_function(file,delete_after=false){if($("#rotdegree").is(':focus')){var dg=document.getElementById("rotdegree").value;document.getElementById("rotate-res").value=dg;}else{var dg=document.getElementById("rotate-res").value;document.getElementById("rotdegree").value=dg;}
if(document.getElementById("left").checked){var side='left';}else if(document.getElementById('right').checked){var side='right';}
document.getElementById("rttresultdiv").innerHTML=".rotate-div{float: "+side+";-ms-transform: rotate("+dg+"deg); /* IE 9 */-webkit-transform: rotate("+dg+"deg); /* Safari */transform: rotate("+dg+"deg);}";document.getElementById("rtt-result-div").innerHTML=".rotate-div{"+"<br>"+"float: "+side+";"+"<br>"+"-ms-transform: rotate("+dg+"deg); /* IE 9 */"+"<br>"+"-webkit-transform: rotate("+dg+"deg); /* Safari */"+"<br>"+"transform: rotate("+dg+"deg);"+"<br>"+"}";}
function rgb2hex(red,green,blue){var rgb=blue|(green<<8)|(red<<16);return'#'+(0x1000000+rgb).toString(16).slice(1)}
function color_picker_func(file,delete_after=false){var hue=document.getElementById("hue").value;var saturation=document.getElementById("saturation").value;var lightness=document.getElementById("lightness").value;var alpha=(document.getElementById("alpha").value/100);var hex=hslToHex(hue,saturation,lightness);var g=hexToRgb(hex).g;var b=hexToRgb(hex).b;var r=hexToRgb(hex).r;document.getElementById("hueres").innerHTML=hue;document.getElementById("saturationres").innerHTML=saturation+"%";document.getElementById("lightnessres").innerHTML=lightness+"%";document.getElementById("hslres").value="hsl("+hue+", "+saturation+"%, "+lightness+"%, "+alpha+")";document.getElementById("rgbres").value="rgb("+r+","+g+","+b+","+alpha+")";document.getElementById("hexres").value=hex;document.getElementById("alphares").innerHTML=alpha;document.getElementById("cpickres").innerHTML=".shaddow-div{background-color: hsl("+hue+", "+saturation+"%, "+lightness+"%, "+alpha+");}.col-sl-red {background: linear-gradient(to right, hsl(0, 100%, 50%) 0%, hsl(57, 100%, 50%) 20%, hsl(110, 100%, 50%) 40%,hsl(236, 100%, 50%) 60% , hsl(305, 100%, 50%) 80%, hsl(0, 100%, 50%) 100%);opacity: "+alpha+"}.col-sl-green{background: linear-gradient(to right,hsl(0, 0%, 50%) 0%, hsl("+hue+", 100%, 50%) 100%);}.col-sl-blue{background: linear-gradient(to right,hsl(0, 0%, 0%) 0%, hsl("+hue+", 99%, 46%) 50%, hsl(0, 0%, 100%) 100%);}.col-sl-alpha{background: linear-gradient(to right,hsl(0, 0%, 100%) 0%, hsl("+hue+", 100%, 50%) 100%);}";}
$(window).load(function(){$('input').focus(function(){this.select();});$('#hex').bind('blur keydown',function(event){var el=this;setTimeout(function(){var rgb=[],$input=$(el),fail=false,original=$input.val(),hex=(original+'').replace(/#/,'');if(original.length===1&&original!=='#'){$input.val('#'+original);}
...
$('#rgb').val(fail?'':'rgb('+rgb.join(',')+')');$('#hsl').val(fail?'':'hsl('+rgbToHsl.apply(null,rgb).join(',')+')');$('#div5').css('backgroundColor',$('#rgb').val());},13);});function rgbToHsl(r,g,b){r/=255,g/=255,b/=255;var max=Math.max(r,g,b),min=Math.min(r,g,b);var h,s,l=(max+min)/2;if(max==min){h=s=0;}
else{var d=max-min;s=l>0.5?d/(2-max-min):d/(max+min);switch(max){case r:h=(g-b)/d+(g<b?6:0);break;case g:h=(b-r)/d+2;break;case b:h=(r-g)/d+4;break;}
h/=6;}
return[(h*100+0.5)|0,((s*100+0.5)|0)+'%',((l*100+0.5)|0)+'%'];}});$(document).ready(function(){if(!("placeholder"in document.createElement("input"))){$("input[placeholder], textarea[placeholder]").each(function(){var val=$(this).attr("placeholder");if(this.value==""){this.value=val;}
$(this).focus(function(){if(this.value==val){this.value="";}}).blur(function(){if($.trim(this.value)==""){this.value=val;}})});$('form').submit(function(){$(this).find("input[placeholder], textarea[placeholder]").each(function(){if(this.value==$(this).attr("placeholder")){this.value="";}});});}});$('.decimal-input').on('keyup mouseup',function(e){var key=e.keyCode||e.charCode;if(key==8||key==46){return false;};let correctValue=$(this).val().toString();if(correctValue.indexOf('.')===-1){correctValue+='.00';}else{if(correctValue.toString().split(".")[1].length===1){correctValue+='0'}
if(correctValue.toString().split(".")[1].length>2){correctValue=parseFloat($(this).val()).toFixed(2).toString();}}
$(this).val(correctValue);});function validate(evt){var theEvent=evt||window.event;if(theEvent.type==='paste'){key=event.clipboardData.getData('text/plain');}else{var key=theEvent.keyCode||theEvent.which;key=String.fromCharCode(key);}
var regex=/[0-9]|\./;if(!regex.test(key)){theEvent.returnValue=false;if(theEvent.preventDefault)theEvent.preventDefault();}}
$(document).ready(function(){$("#Searchcalculator").on("keyup",function(){var value=$(this).val().toLowerCase();$("#Searchtr tr").filter(function(){$(this).toggle($(this).text().toLowerCase().indexOf(value)>-1)});});});function sdw_function2(){if(document.getElementById('inset').checked){inset="inset";}else if(document.getElementById('outline').checked){inset='';}
if(document.getElementById("high-res").value<=100&&document.getElementById("high-res").value>=-100){var high=document.getElementById("high-res").value;}else{var high=0}
if(document.getElementById("left-res").value<=100&&document.getElementById("left-res").value>=-100){var left=document.getElementById("left-res").value;}else{var left=0}
if(document.getElementById("rad-res").value<=100&&document.getElementById("rad-res").value>=-100){var rad=document.getElementById("rad-res").value;}else{var rad=0}
if(document.getElementById("blur-res").value<=100&&document.getElementById("blur-res").value>=-100){var blur=document.getElementById("blur-res").value;}else{var blur=0}
if(document.getElementById("opac-res").value<=1&&document.getElementById("opac-res").value>=0){var op=document.getElementById("opac-res").value;}else{var op=0}
var shwcolor1=document.getElementById("shw-color").value;document.getElementById("high").value=high;document.getElementById("left").value=left;document.getElementById("rad").value=rad;document.getElementById("blur").value=blur;document.getElementById("opacity").value=op*100;var g=hexToRgb(shwcolor1).g;var b=hexToRgb(shwcolor1).b;var r=hexToRgb(shwcolor1).r;document.getElementById("sdw-result").innerHTML=".shaddow-div{-webkit-box-shadow: "+inset+" "+high+"px "+left+"px "+blur+"px "+rad+"px "+"rgba("+r+","+g+","+b+","+op+");"+";-moz-box-shadow: "+inset+" "+high+"px "+left+"px "+blur+"px "+rad+"px "+"rgba("+r+","+g+","+b+","+op+");"+";box-shadow: "+inset+" "+high+"px "+left+"px "+blur+"px "+rad+"px "+"rgba("+r+","+g+","+b+","+op+");"+";}";document.getElementById("sdw-result-div").innerHTML=".shadow-div{"+"<br>"+"-webkit-box-shadow: "+inset+" "+high+"px "+left+"px "+blur+"px "+rad+"px "+"rgba("+r+","+g+","+b+","+op+");"+"<br>"+"-moz-box-shadow: "+inset+" "+high+"px "+left+"px "+blur+"px "+rad+"px "+"rgba("+r+","+g+","+b+","+op+");"+"<br>"+"box-shadow: "+inset+" "+high+"px "+left+"px "+blur+"px "+rad+"px "+"rgba("+r+","+g+","+b+","+op+");"+"<br>"+"}";}
$('#code-show').on('shown.bs.collapse',function(){$("#viewcode").css('display','none');$("#hidecode").css('display','');});$('#code-show').on('hidden.bs.collapse',function(){$("#viewcode").css('display','');$("#hidecode").css('display','none');});function bondpricecalc(file,delete_after=false){var rate=document.getElementById("rate").value/100;var crate=document.getElementById("crate").value/100;var pvalue=document.getElementById("pvalue").value;var time=document.getElementById("time").value;var curr=document.getElementById("curr").value;var total=0;for(var i=1;i<=time;i++){total+=(pvalue*crate)/(Math.pow((1+rate),i));}
var ex=(pvalue)/(Math.pow((1+rate),time));if(rate==""||crate==""||pvalue==""||time==""){}else{$("#resulttable").css('display','');document.getElementById("bpresult").innerHTML=number_format((total+ex),2)+" "+curr;}}
function bondcalcreset(){document.getElementById('rate').value="";document.getElementById('crate').value="";document.getElementById('pvalue').value="";document.getElementById('time').value="";$("#resulttable").css('display','none');$("#success").css('display','none');$(".fail-func").css('display','none');$("#reseted").css('display','');}
function ratofretreset(){document.getElementById('cpayment').value="";document.getElementById('initpayment').value="";document.getElementById('nextprice').value="";$("#resulttable").css('display','none');$("#success").css('display','none');$(".fail-func").css('display','none');$("#reseted").css('display','');}
function bondpcalcman(){bondpricecalc();var rate=document.getElementById("rate").value;var pvalue=document.getElementById("pvalue").value;var crate=document.getElementById("crate").value;var time=document.getElementById("time").value;if(rate===""||pvalue===""||time===""||crate===""){$("#reseted").css('display','none');$("#success").css('display','none');$(".fail-func").css('display','').delay(3000).fadeOut();}else{$("#reseted").css('display','none');$(".fail-func").css('display','none');$("#success").css('display','').delay(3000).fadeOut();}}
function inflcalfunct(file,delete_after=false){var rgdbatt=document.getElementById("rgdbatt").value;var rgdbatt1=document.getElementById("rgdbatt1").value;var ngdpatt=document.getElementById("ngdpatt").value;var ngdpatt1=document.getElementById("ngdpatt1").value;var curr=document.getElementById("curr").value;for(var i=0;i<4;i++){document.getElementsByClassName("curry")[i].innerHTML=curr;}
if(rgdbatt==""||rgdbatt1==""||ngdpatt==""||ngdpatt1==""){}else{$("#resulttable").css('display','');t=ngdpatt/rgdbatt;t1=ngdpatt1/rgdbatt1;document.getElementById("bpresult").innerHTML=number_format(((t1-t)/t),2)*100+"%";}}
function inflcalfunctman(){inflcalfunct();var rgdbatt=document.getElementById("rgdbatt").value;var rgdbatt1=document.getElementById("rgdbatt1").value;var ngdpatt=document.getElementById("ngdpatt").value;var ngdpatt1=document.getElementById("ngdpatt1").value;if(rgdbatt===""||rgdbatt1===""||ngdpatt===""||ngdpatt1===""){$("#reseted").css('display','none');$("#success").css('display','none');$(".fail-func").css('display','').delay(3000).fadeOut();}else{$("#reseted").css('display','none');$(".fail-func").css('display','none');$("#success").css('display','').delay(3000).fadeOut();}}
function inflcalcreset(){document.getElementById('rgdbatt').value="";document.getElementById('rgdbatt1').value="";document.getElementById('ngdpatt').value="";document.getElementById('ngdpatt1').value="";$("#resulttable").css('display','none');$("#success").css('display','none');$(".fail-func").css('display','none');$("#reseted").css('display','');}
function returnratecalc(file,delete_after=false){var cpayment=document.getElementById("cpayment").value;var initpayment=document.getElementById("initpayment").value;var nextprice=document.getElementById("nextprice").value;var res=(+cpayment+ +nextprice-+initpayment)/initpayment*100;if(cpayment==""||initpayment==""||nextprice==""){}else{$("#resulttable").css('display','');document.getElementById("rrresult").innerHTML=number_format(res,2)+"%";}}
function returnratecalcman(){returnratecalc();var cpayment=document.getElementById("cpayment").value;var initpayment=document.getElementById("initpayment").value;var nextprice=document.getElementById("nextprice").value;if(cpayment===""||initpayment===""||nextprice===""){$("#reseted").css('display','none');$("#success").css('display','none');$(".fail-func").css('display','').delay(3000).fadeOut();}else{$("#reseted").css('display','none');$(".fail-func").css('display','none');$("#success").css('display','').delay(3000).fadeOut();}}
function deleteAllCookies(){var cookies=document.cookie.split(";");for(var i=0;i<cookies.length;i++){var cookie=cookies[i];var eqPos=cookie.indexOf("=");var now=new Date();var time=now.getTime();time+=3600*1000;now.setTime(time);var name=eqPos>-1?cookie.substr(0,eqPos):cookie;document.cookie=name+"=;expires="+now.toUTCString()+";";}}
