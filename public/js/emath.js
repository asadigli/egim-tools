(function(e, t) {
    ...
    function N(t, o, i) {
        ...
        return n.forEach(function(t) {t.function&&console.warn('`modifier.function` is deprecated, use `modifier.fn`!');var i=t.function||t.fn;t.enabled&&e(i)&&(o.offsets.popper=c(o.offsets.popper),o.offsets.reference=c(o.offsets.reference),o=i(o,t))}), o
    }
    function k() {
...
function charcountupdate(str) {
  ...
  // var size = str.split(/%..|./).length - 1;
  if (lng == 0) {
    var lng3 = 0;
  }else{
    var lng3 = str.trim().split(/\s+/).length
  }
  document.getElementById("charcount").innerHTML = lng - lng2;
  document.getElementById("wordcount").innerHTML = lng3;
  document.getElementById("spaceCount").innerHTML = lng2;
  getStringMemorySize(str);
}
getStringMemorySize = function( _string ) {
    ...
    document.getElementById("size").innerHTML = formatBytes(accum);
}
...
function boradcreate(){
    var lefttop = document.getElementById("lefttop").value;
    document.getElementById("rlt").value = lefttop;
    var righttop = document.getElementById("righttop").value;
    document.getElementById("rrt").value = righttop;
    var leftbottom = document.getElementById("leftbottom").value;
    document.getElementById("rlb").value = leftbottom;
    var rightbottom = document.getElementById("rightbottom").value;
    document.getElementById("rrb").value = rightbottom;
    bor_func(lefttop, righttop, leftbottom,rightbottom);
}
function boradcreate2(){
    var lefttop = document.getElementById("rlt").value;
    document.getElementById("lefttop").value = lefttop;
    var righttop = document.getElementById("rrt").value;
    document.getElementById("righttop").value = righttop;
    var leftbottom = document.getElementById("rlb").value;
    document.getElementById("leftbottom").value = leftbottom;
    var rightbottom = document.getElementById("rrb").value;
    document.getElementById("rightbottom").value = rightbottom;
    bor_func(lefttop, righttop, leftbottom,rightbottom);
}
function bor_func(lt,rt,lb,rb) {
    var lefttop = lt;
    var righttop = rt;
    var leftbottom = lb;
    var rightbottom = rb;
  document.getElementById("borad-result").innerHTML = ".example-div{"+"<br>"+"border-radius: "+lefttop+"px "+righttop+"px "+leftbottom+"px "+rightbottom+"px;"+"<br>"+"-moz-border-radius: "+lefttop+"px "+righttop+"px "+leftbottom+"px "+rightbottom+"px;"+"<br>"+"-webkit-border-radius: "+lefttop+"px "+righttop+"px "+leftbottom+"px "+rightbottom+"px;"+"<br>"+"}";
  document.getElementById("boradstyle").innerHTML = ".sdwpic, .shaddow-div{border-radius: "+lefttop+"px "+righttop+"px "+leftbottom+"px "+rightbottom+"px; -moz-border-radius: "+lefttop+"px "+righttop+"px "+leftbottom+"px "+rightbottom+"px; -webkit-border-radius: "+lefttop+"px "+righttop+"px "+leftbottom+"px "+rightbottom+"px;}";
}

function allboradcreate(){
    var allcorns = document.getElementById("allcorns").value;
    document.getElementById("alcrs").value = allcorns;
    allbor_func(allcorns);
}
function allboradcreate2(){
    var allcorns = document.getElementById("alcrs").value;
    document.getElementById("allcorns").value = allcorns;
    allbor_func(allcorns);
}
function allbor_func(alc) {
  var ab = alc;
  document.getElementById("lefttop").value = ab;
  document.getElementById("righttop").value = ab;
  document.getElementById("leftbottom").value = ab;
  document.getElementById("rightbottom").value = ab;
  document.getElementById("rlt").value = ab;
  document.getElementById("rrt").value = ab;
  document.getElementById("rlb").value = ab;
  document.getElementById("rrb").value = ab;
  bor_func(ab,ab,ab,ab);
}
function sdw_function2() {
  if (document.getElementById('inset').checked) {
	  inset = "inset";
  }else if(document.getElementById('outline').checked){
	  inset = '';
  }
  if (document.getElementById("high-res").value <= 100 && document.getElementById("high-res").value >= -100) {
    var high = document.getElementById("high-res").value;
  }else { var high = 0}
  if (document.getElementById("left-res").value <= 100 && document.getElementById("left-res").value >= -100){
    var left = document.getElementById("left-res").value;
  }else { var left = 0}
  if (document.getElementById("rad-res").value <= 100 && document.getElementById("rad-res").value >= -100){
    var rad = document.getElementById("rad-res").value;
  }else { var rad = 0}
  if (document.getElementById("blur-res").value <= 100 && document.getElementById("blur-res").value >= -100){
    var blur = document.getElementById("blur-res").value;
  }else { var blur = 0}
  if (document.getElementById("opac-res").value <= 1 && document.getElementById("opac-res").value >= 0){
    var op = document.getElementById("opac-res").value;
  }else { var op = 0}
  var shwcolor1 = document.getElementById("shw-color").value;
  ...
  document.getElementById("opacity").value = op*100;
  var g = hexToRgb(shwcolor1).g;
  var b = hexToRgb(shwcolor1).b;
  var r = hexToRgb(shwcolor1).r;
  document.getElementById("sdw-result").innerHTML = ".shaddow-div{-webkit-box-shadow: "+inset + " "+high+"px "+left+"px "+blur+"px "+rad+"px "+"rgba("+ r +","+ g +","+ b +","+op+");"+";-moz-box-shadow: "+inset + " "+high+"px "+left+"px "+blur+"px "+rad+"px "+"rgba("+ r +","+ g +","+ b +","+op+");"+";box-shadow: "+inset + " "+high+"px "+left+"px "+blur+"px "+rad+"px "+ "rgba("+ r +","+ g +","+ b +","+op+");"+";}";
  document.getElementById("sdw-result-div").innerHTML = ".shadow-div{"+"<br>"+"-webkit-box-shadow: "+inset + " " +high+"px "+left+"px "+blur+"px "+rad+"px "+"rgba("+ r +","+ g +","+ b +","+op+");"+"<br>"+"-moz-box-shadow: "+inset + " "+high+"px "+left+"px "+blur+"px "+rad+"px "+"rgba("+ r +","+ g +","+ b +","+op+");"+"<br>"+"box-shadow: "+inset + " "+high+"px "+left+"px "+blur+"px "+rad+"px "+"rgba("+ r +","+ g +","+ b +","+op+");"+"<br>"+"}";
}
function Sdw_function() {
  if (document.getElementById('inset').checked) {
  ...
  var op2 = document.getElementById("opacity").value;
  var op = (op2/100);
  document.getElementById("high-res").value = high;
  document.getElementById("left-res").value = left;
  document.getElementById("rad-res").value = rad;
  document.getElementById("blur-res").value = blur;
  document.getElementById("opac-res").value = op;
  var g = hexToRgb(shwcolor1).g;
  var b = hexToRgb(shwcolor1).b;
  var r = hexToRgb(shwcolor1).r;
  document.getElementById("sdw-result").innerHTML = ".shaddow-div{-webkit-box-shadow: "+inset + " "+high+"px "+left+"px "+blur+"px "+rad+"px "+"rgba("+ r +","+ g +","+ b +","+op+");"+";-moz-box-shadow: "+inset + " "+high+"px "+left+"px "+blur+"px "+rad+"px "+"rgba("+ r +","+ g +","+ b +","+op+");"+";box-shadow: "+inset + " "+high+"px "+left+"px "+blur+"px "+rad+"px "+ "rgba("+ r +","+ g +","+ b +","+op+");"+";}";
...
function btn_function() {
  var btnborder = document.getElementById("btnborder").value;
  var btnfontsize = document.getElementById("btnfontsize").value;
  var btnradius = document.getElementById("btnradius").value;
  var btncolor = document.getElementById("btncolor").value;
  var btn_txt_color = document.getElementById("btn_txt_color").value;
  var btn_border_color = document.getElementById("btn_border_color").value;
  document.getElementById("rresult").value = btnradius;
  document.getElementById("fresult").value = btnfontsize;
  document.getElementById("bbresult").value = btnborder;
  document.getElementById("btn-result").innerHTML = ".my-button{border-radius: "+btnradius+"px;background-color: "+btncolor+"; border: "+btnborder+"px solid "+btn_border_color+";color: "+btn_txt_color+";padding: 15px 32px;text-align: center;text-decoration: none;display: inline-block;font-size: "+btnfontsize+"px;}";
  document.getElementById("btn-result-div").innerHTML = ".my-button{ "+"<br>"+"border-radius:"+btnradius+"px; "+"<br>"+"background-color: "+btncolor+"; "+"<br>"+"border: "+btnborder+"px solid "+btn_border_color+";"+"<br>"+"color: "+btn_txt_color+";"+"<br>"+"padding: 15px 32px;"+"<br>"+"text-align: center;"+"<br>"+"text-decoration: none;"+"<br>"+"display: inline-block;"+"<br>"+"font-size: "+btnfontsize+"px; "+"<br>"+"}";
}

function btn_function2() {
  var btncolor = document.getElementById("btncolor").value;
  var btn_txt_color = document.getElementById("btn_txt_color").value;
  var btn_border_color = document.getElementById("btn_border_color").value;
  if (document.getElementById("bbresult").value <= 20 && document.getElementById("bbresult").value >= 0) {
    var btnborder = document.getElementById("bbresult").value;
  }else{var btnborder = 0}
  if (document.getElementById("fresult").value <= 50 && document.getElementById("fresult").value >= 1) {
    var btnfontsize = document.getElementById("fresult").value;
  }else{var btnfontsize = 0}
  if (document.getElementById("rresult").value <= 50 && document.getElementById("rresult").value >= 1) {
    var btnradius = document.getElementById("rresult").value;
  }else{var btnradius = 0}
  document.getElementById("btnradius").value = btnradius;
  document.getElementById("btnfontsize").value = btnfontsize;
  document.getElementById("btnborder").value = btnborder;
  document.getElementById("btn-result").innerHTML = ".my-button{border-radius: "+btnradius+"px;background-color: "+btncolor+"; border: "+btnborder+"px solid "+btn_border_color+";color: "+btn_txt_color+";padding: 15px 32px;text-align: center;text-decoration: none;display: inline-block;font-size: "+btnfontsize+"px;}";
  document.getElementById("btn-result-div").innerHTML = ".my-button{ "+"<br>"+"border-radius:"+btnradius+"px; "+"<br>"+"background-color: "+btncolor+"; "+"<br>"+"border: "+btnborder+"px solid "+btn_border_color+";"+"<br>"+"color: "+btn_txt_color+";"+"<br>"+"padding: 15px 32px;"+"<br>"+"text-align: center;"+"<br>"+"text-decoration: none;"+"<br>"+"display: inline-block;"+"<br>"+"font-size: "+btnfontsize+"px; "+"<br>"+"}";
}

function resetcssminfunction() {
    document.getElementById('css_text').value = "";
    document.getElementById("mincharcount").innerHTML = "0";
}
function resettextjsonfunction() {
  document.getElementById('input').innerHTML = "";
  document.getElementById('output').innerHTML = "";
    document.getElementById("mincharcount").innerHTML = "0";
}
function copycssminified() {
  if (document.getElementById('css_text').value === "") {
      $("#text").css("display","").delay(6000).fadeOut();
      $("#success-text").css("display","none").delay(6000).fadeOut();
      $("#copiedmincss").css("display","none").delay(6000).fadeOut();
  }else{
      $("#text").css("display","none").delay(6000).fadeOut();
      $("#success-text").css("display","none").delay(6000).fadeOut();
      $("#copiedmincss").css("display","").delay(6000).fadeOut();
  }
  let textarea = document.getElementById("css_text");
  textarea.select();
...
function cpikcer_code_copy() {
  let input = document.getElementById("rgbres");
  input.select();
  document.execCommand("copy");
  $("#copied").css('display','none');
  $("#copied").css('display','').delay(6000).fadeOut();
}
function hcpikcer_code_copy() {
  let input = document.getElementById("hslres");
  input.select();
  document.execCommand("copy");
  $("#copied").css('display','none');
  $("#copied").css('display','').delay(6000).fadeOut();
}
function hexcpikcer_code_copy() {
  let input = document.getElementById("hexres");
  input.select();
  document.execCommand("copy");
  $("#copied").css('display','none');
  $("#copied").css('display','').delay(6000).fadeOut();
...
function copyhexcode() {
  ...
  input.select();
  document.execCommand("copy");
  $("#copied").css('display','none').delay(6000).fadeOut();
  $("#copied").css('display','').delay(6000).fadeOut();
}
function copyhlscode() {
  let input = document.getElementById("hsl");
  input.select();
  document.execCommand("copy");
  $("#copied").css('display','none').delay(6000).fadeOut();
  $("#copied").css('display','').delay(6000).fadeOut();
...
function copypassword() {
  let input = document.getElementById("pssgnt");
  input.select();
  document.execCommand("copy");
  $("#copied").css('display','').delay(6000).fadeOut();
  $("#copied").css('display','').delay(6000).fadeOut();
}
function cssminify_function() {
  var minifyres = document.getElementById("css_text").value;
  $("#minifierform")[0].reset();
  t = minifyres.replace(/ +(?= )/g,"").replace(/\/\*(.|[\r\n])*?\*\//g, "");
  text2 = t.replace(/\s+/g,' ').replace(/ {/g, '{').replace(/ }/g, '}').replace(/; /g, ';');
  document.getElementById("css_text").innerHTML = text2;
  var lng1 = text2.length;
  document.getElementById("mincharcount").innerHTML = lng1;
  if (minifyres === "") {
    $("#text").css("display","").delay(6000).fadeOut();
    $("#success-text").css("display","none").delay(6000).fadeOut();
    $("#copiedmincss").css("display","none").delay(6000).fadeOut();
    ...
    $("#text").css("display","none").delay(6000).fadeOut();
    $("#success-text").css("display","").delay(6000).fadeOut();
    $("#copiedmincss").css("display","none").delay(6000).fadeOut();
  }
}
...
function texttojson() {
  ...
  text2 = input.replace(/[^a-zA-Z0-9]/g, ' ').trim().replace(/\s+/g,',');
  var text4 = "";
  for (var i = 0; i < text2.split(',').length; i++) {
    if ([i] == (text2.split(',').length-1)) {var last = "'";}else{var last = "',";}
      txt = text2.split(',')[i];
      text4 += "    '" + txt + last+ "\n";
  }
  if (input !== "") {
...
var openFile = function(event) {
   // resettextjsonfunction();
    ...
    reader.onload = function(){
        ...
        node.value = text;
        minifiedcharcount(text);
    };
  reader.readAsText(input.files[0]);
};

function uncssminify_function() {
  var minifyres = document.getElementById("css_text").value;
  $("#minifierform")[0].reset();
  text = minifyres.replace(/\/\*(.|[\r\n])*?\*\//g, "");
  t = text.replace(/ +(?= )/g," ").replace(/\r?\n|\r/g, "");
  t2 = t.replace(/\s+/g,' ');
  text2 = t2.replace(/{/g,"{\n   ").replace(/;/g,";\n   ").replace(/   }/g,"}\n");
  document.getElementById("css_text").innerHTML = text2;
  var lng1 = text2.length;
...
function csscommcleaner() {
  var minifyres = document.getElementById("css_text").value;
  $("#minifierform")[0].reset();
  text = minifyres.replace(/\/\*(.|[\r\n])*?\*\//g, "").replace(/\n\s*\n/g, '\n');
  document.getElementById("css_text").innerHTML = text;
  document.getElementById("mincharcount").innerHTML = text.length;
  if (minifyres === "") {
    $("#text").css("display","").delay(6000).fadeOut();
    $("#success-text").css("display","none").delay(6000).fadeOut();
    $("#copiedmincss").css("display","none").delay(6000).fadeOut();
...
function text_maker(){
    var fntsize = document.getElementById("fntsize").value;
    document.getElementById("rfntsize").value = fntsize;
    var ltrspc = document.getElementById("ltrspc").value;
    document.getElementById("rltrspc").value = ltrspc;
    var wrdspc = document.getElementById("wrdspc").value;
    document.getElementById("rwrdspc").value = wrdspc;
    var sdwhor = document.getElementById("sdwhor").value;
    document.getElementById("rsdwhor").value = sdwhor;
    var sdwver = document.getElementById("sdwver").value;
    document.getElementById("rsdwver").value = sdwver;
    var sdwblr = document.getElementById("sdwblr").value;
    document.getElementById("rsdwblr").value = sdwblr;
    text_make_function(fntsize, ltrspc, wrdspc, sdwhor, sdwver, sdwblr);

}
function text_maker2(){
  var fntsize = document.getElementById("rfntsize").value;
  document.getElementById("fntsize").value = fntsize;
  var ltrspc = document.getElementById("rltrspc").value;
  document.getElementById("ltrspc").value = ltrspc;
  var wrdspc = document.getElementById("rwrdspc").value;
  document.getElementById("wrdspc").value = wrdspc;
  var sdwhor = document.getElementById("rsdwhor").value;
  document.getElementById("sdwhor").value = sdwhor;
  var sdwver = document.getElementById("rsdwver").value;
  document.getElementById("sdwver").value = sdwver;
  var sdwblr = document.getElementById("rsdwblr").value;
  document.getElementById("sdwblr").value = sdwblr;
  text_make_function(fntsize, ltrspc, wrdspc, sdwhor, sdwver, sdwblr);
}
function text_make_function(t, a, b, c, d, e) {
  var fntsize = t;var ltrspc = a; var wrdspc = b; var sdwhor = c; var sdwver = d; var sdwblr = e;
  var textclr = document.getElementById("textclr").value;
  var shwcolor = document.getElementById("shwcolor").value;
  var fontfam = document.getElementById("fontfam").value;
  var textdoc = document.getElementById("textdoc").value;
  var txttrans = document.getElementById("txttrans").value;
  var fontstyle = document.getElementById("fontstyle").value;
  var fontweight = document.getElementById("fontweight").value;
  var text = document.getElementById("text").value;
  var fdr = document.getElementById("fontdirection").value;
  document.getElementById("texthere").innerHTML = text;
  document.getElementById("glink").href = "https://fonts.googleapis.com/css?family="+fontfam+"";
  document.getElementById("goog-link").innerHTML = "link href='https://fonts.googleapis.com/css?family="+fontfam+"'"
  document.getElementById("textstyle").innerHTML = ".example-text{ font-family: '"+fontfam+"'; font-style: "+fontstyle+"; font-weight: "+fontweight+"; color: "+textclr+"; font-size: "+fntsize+"px; text-decoration: "+textdoc+"; text-transform: "+txttrans+"; letter-spacing: "+ltrspc+"px; direction: "+fdr+"; word-spacing: "+wrdspc+"px; text-shadow: "+sdwhor+"px "+sdwver+"px "+sdwblr+"px "+shwcolor+";}";
  document.getElementById("font-result").innerHTML = ".example-text{"+"<br>"+" font-family: '"+fontfam+"'; "+"<br>"+" font-style: "+fontstyle+"; "+"<br>"+" font-weight: "+fontweight+"; "+"<br>"+" color: "+textclr+"; "+"<br>"+" font-size: "+fntsize+"px; "+"<br>"+" text-decoration: "+textdoc+"; "+"<br>"+" text-transform: "+txttrans+"; "+"<br>"+" letter-spacing: "+ltrspc+"px; "+"<br>"+" direction: "+fdr+"; "+"<br>"+" word-spacing: "+wrdspc+"px; "+"<br>"+" text-shadow: "+sdwhor+"px "+sdwver+"px "+sdwblr+"px "+shwcolor+";"+"<br>"+" }";
}
function minifiedcharcount(str){var string = str.length;document.getElementById("mincharcount").innerHTML = string;}
function slug(str, sepin) {
  str = str.replace("ə", 'e').replace("ş", 'sh').replace("ç", 'ch').replace("ı", 'i');
...
function make_slug_func() {
  var slugin = document.getElementById("slugin").value;
  var sepin = document.getElementById("sepin").value;
  var result = slug(slugin, sepin);
  document.getElementById("slugin").value = result;
}
function resetaprcalculation() {
    $("#amount, #apr").val("");
    $("#warning").html('<b class="success-func">'+$("#warning").data("words").split(',')[1]+'</b>');
   	$("#resulttable").html("");
}
function pvcalculatorreset() {
    $("#time,#rate,#amount").val("");
   	$("#resulttable").css('display','none');
   	$("#success").css('display','none');
    $(".fail-func").css('display','none');
   	$("#reseted").css('display','');
}
...
function apr_calc_function(file, delete_after = false) {
  var arr = $("#resulttable").data("words").split(',');
  var apr = $("#apr").val();
  var amount = $("#amount").val();
  var month = $("#month").val();
  var curr = $("#curr").val();
  $("#currency").html("("+curr+")");
  if (month >= 12) {$(".yamount").css('display','');}else{$(".yamount").css('display','none');}
  if (apr === "" || amount === "") {$("#resulttable").html("");}else{
    $("#resulttable").html("<table class='vertical-table'><tr><td>"+arr[0]+"</td><td>"+$("#month option:selected").text()+"</td></tr><tr><td>"+arr[1]+"</td><td>"+number_format(((apr / 100 / 12) * amount) / (1 - (Math.pow((1 + (apr/ 100 / 12)),-month))), 2)+" "+curr+"</td></tr><tr><td>"+arr[2]+"</td><td>"+number_format(((apr / 100 / 12) * amount)*12 / (1 - (Math.pow((1 + (apr/ 100 / 12)),-month))), 2) +" "+curr+"</td></tr><tr><td>"+arr[3]+"</td><td>"+number_format((((apr / 100 / 12) * amount) / (1 - (Math.pow((1 + (apr/ 100 / 12)),-month)))) * month, 2)+" "+curr+"</td></tr><tr><td>"+arr[4]+"</td><td>"+number_format((((apr / 100 / 12) * amount) / (1 - (Math.pow((1 + (apr/ 100 / 12)),-month)))) * month - amount, 2)+" "+curr+"</td></tr></table>");
  }
}

setInterval(function(){$(this).html("")}, 6000);

function pvcalculate(file, delete_after = false) {
  ...
  document.getElementById("pvresult").innerHTML = number_format(amount/(Math.pow((1 + rate),time)), 2) + ' ' + curr;
}
function fvcalculate(file, delete_after = false) {
  var rate = document.getElementById("rate").value / 100;
  var amount = document.getElementById("amount").value;
  var time = document.getElementById("time").value;
  var curr = document.getElementById("curr").value;
  $("#resulttable").css('display','');
  document.getElementById("fvresult").innerHTML = number_format(amount*(Math.pow((1 + rate),time)), 2) + ' ' + curr;
}
function calculatemanually(){
  apr_calc_function();
  if ($("#apr").val() === "" || $("#amount").val() === "") {
    $("#warning").html('<b class="fail-func">'+$("#warning").data("words").split(',')[0]+'</b>');
  }else{
    $("#warning").html('<b class="success-func">'+$("#warning").data("words").split(',')[2]+'</b>');
  }
}
function pvcalcman(){
  pvcalculate();
  ...
  var time = document.getElementById("time").value;
  if (apr === "" || amount === "" || time === "") {
  	$("#reseted").css('display','none');
  	$("#success").css('display','none');
  	$(".fail-func").css('display','').delay(3000).fadeOut();
  }else{
  	$("#reseted").css('display','none');
  	$(".fail-func").css('display','none');
  	$("#success").css('display','').delay(3000).fadeOut();
  }
}
function fvcalcman(){
  fvcalculate();
  ...
  var time = document.getElementById("time").value;
  if (apr === "" || amount === "" || time === "") {
  	$("#reseted").css('display','none');	$("#success").css('display','none');	$(".fail-func").css('display','').delay(3000).fadeOut();
  }else{ 	$("#reseted").css('display','none');	$(".fail-func").css('display','none');	$("#success").css('display','').delay(3000).fadeOut();
  }
}
function pwdbutton(){
    if (document.getElementById("pssgntnmb").value >= document.getElementById("rpssgntnmb").value) {
        generatepwd();
    }else{
        generatepwd2();
    }
...
function generatepwd(){
    var numb = document.getElementById("pssgntnmb").value;
    document.getElementById("rpssgntnmb").value = numb;
    pwd2(numb);
}
function generatepwd2(){
    var numb = document.getElementById("rpssgntnmb").value;
    document.getElementById("pssgntnmb").value = numb;
    pwd2(numb);
}
function pwd2(num, file, delete_after = false) {
  var numb = num;
  var text = '';
  if (document.getElementById('pwd3').checked) {
  	var p3 = "!@#$%";
  }else{var p3 = '';}if (document.getElementById('pwd5').checked) {
  	var p5 = "&'()*+,-./:;<=>?[]^_`{|}~";
  }else{var p5 = '';}if (document.getElementById('pwd2').checked) {
  	var p2 = "abcdefghijklmnopqrstuvwxyz";
  }else{var p2 = '';}if (document.getElementById('pwd4').checked) {
  	var p4 = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
  }else{var p4 = '';}if (document.getElementById('pwd1').checked) {
  	var p1 = "0123456789";
  }else{var p1 = '';}
  var possible = p1 + p2 + p3 + p4 + p5;
  for (var i = 0; i < numb; i++){
  	text += possible.charAt(Math.floor(Math.random() * possible.length));
  }
  	document.getElementById("pssgnt").value = text;
    checked = $("input[type=checkbox]:checked").length;
    if(!checked) {
        $("#validate").css('display','');
        return false;
    }else{
      $("#validate").css('display','none');
    }
}
if (window.location.href.match('/password-generator') != null) {
...
$(document).ready(function(){
  $("#Searchtools").on("keyup", function() {
    ...
    $("#Searchtls tr").filter(function() {
        $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
      });
    });
});
function rotate_div_function(){
    var dg = document.getElementById("rotdegree").value;
    document.getElementById("rotate-res").value = dg;
    rot_func(dg);
}
function rotate_div_function2(){
    var dg = document.getElementById("rotate-res").value;
    document.getElementById("rotdegree").value = dg;
    rot_func(dg);
}
function rot_func(dg, file, delete_after = false) {
  var dg = dg;
  ...
  document.getElementById("rttresultdiv").innerHTML = ".rotate-div{float: "+side+";-ms-transform: rotate("+dg+"deg); /* IE 9 */-webkit-transform: rotate("+dg+"deg); /* Safari */transform: rotate("+dg+"deg);}";
  document.getElementById("rtt-result-div").innerHTML = ".rotate-div{"+"<br>"+"float: "+side+";"+"<br>"+"-ms-transform: rotate("+dg+"deg); /* IE 9 */"+"<br>"+"-webkit-transform: rotate("+dg+"deg); /* Safari */"+"<br>"+"transform: rotate("+dg+"deg);"+"<br>"+"}";
}
function rgb2hex(red, green, blue) {
        var rgb = blue | (green << 8) | (red << 16);
        return '#' + (0x1000000 + rgb).toString(16).slice(1)
}
function color_picker_func(file, delete_after = false) {
  ...
  document.getElementById("hueres").innerHTML = hue;
  document.getElementById("saturationres").innerHTML = saturation + "%";
  document.getElementById("lightnessres").innerHTML = lightness + "%";
  document.getElementById("hslres").value = "hsl("+hue+", "+saturation+"%, "+lightness+"%, "+alpha+")";
  document.getElementById("rgbres").value = "rgb("+r+","+g+","+b+","+alpha+")";
  document.getElementById("hexres").value = hex;
  document.getElementById("alphares").innerHTML = alpha;
  document.getElementById("cpickres").innerHTML = ".shaddow-div{background-color: hsl("+hue+", "+saturation+"%, "+lightness+"%, "+alpha+");}.col-sl-red {background: linear-gradient(to right, hsl(0, 100%, 50%) 0%, hsl(57, 100%, 50%) 17%, hsl(110, 100%, 50%) 40%,hsl(236, 100%, 50%) 60% , hsl(305, 100%, 50%) 80%, hsl(0, 100%, 50%) 100%);opacity: "+alpha+"}.col-sl-green{background: linear-gradient(to right,hsl(0, 0%, 50%) 0%, hsl("+hue+", 100%, "+lightness+"%) 100%);}.col-sl-blue{background: linear-gradient(to right,hsl(0, 0%, 0%) 0%, hsl("+hue+", "+saturation+"%, 46%) 50%, hsl(0, 0%, 100%) 100%);}.col-sl-alpha{background: linear-gradient(to right,hsl(0, 0%, 100%) 0%, hsl("+hue+", "+saturation+"%, "+lightness+"%) 100%);}";
}
...
$('#hex').bind('blur keydown', function (event) {
  ...
  setTimeout(function () {
    ...
    $('#div5').css('backgroundColor', $('#rgb').val());
    }, 13);
});
...
$('.decimal-input').on('keyup mouseup', function (e) {
...
$(document).ready(function(){
  $("#Searchcalculator").on("keyup", function() {
    var value = $(this).val().toLowerCase();
    $("#Searchtr tr").filter(function() {
      $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
    });
  });
});
$('#code-show').on('shown.bs.collapse', function () {
    $("#viewcode").css('display','none');
    $("#hidecode").css('display','');
});
$('#code-show').on('hidden.bs.collapse', function () {
    $("#viewcode").css('display','');
    $("#hidecode").css('display','none');
});
function bondpricecalc(file, delete_after = false) {
  var rate = document.getElementById("rate").value / 100;
  var crate = document.getElementById("crate").value / 100;
  var pvalue = document.getElementById("pvalue").value;
  var time = document.getElementById("time").value;
  var curr = document.getElementById("curr").value;
  var total = 0;
  for (var i  = 1; i <= time; i++){
      total  += (pvalue * crate)/(Math.pow((1 + rate),i));
  }
  var ex = (pvalue)/(Math.pow((1 + rate),time));
  if (rate == "" || crate == "" || pvalue == "" || time == "") {
  }else{
    $("#resulttable").css('display','');
    document.getElementById("bpresult").innerHTML = number_format((total + ex),2) +" "+curr;
  }
}
function bondcalcreset() {
...
function ratofretreset() {
    document.getElementById('cpayment').value = "";
    document.getElementById('initpayment').value = "";
    document.getElementById('nextprice').value = "";
 	$("#resulttable").css('display','none');
 	$("#success").css('display','none');
  	$(".fail-func").css('display','none');
 	$("#reseted").css('display','');
}
function bondpcalcman(){
  bondpricecalc();
  var rate = document.getElementById("rate").value;
  var pvalue = document.getElementById("pvalue").value;
  var crate = document.getElementById("crate").value;
  var time = document.getElementById("time").value;
  if (rate === "" || pvalue === "" || time === "" || crate === "") {
  	$("#reseted").css('display','none');
  	$("#success").css('display','none');
  	$(".fail-func").css('display','').delay(3000).fadeOut();
  }else{
...
function inflcalfunct(file, delete_after = false) {
  var rgdbatt = document.getElementById("rgdbatt").value;
  var rgdbatt1 = document.getElementById("rgdbatt1").value;
  var ngdpatt = document.getElementById("ngdpatt").value;
  var ngdpatt1 = document.getElementById("ngdpatt1").value;
  var curr = document.getElementById("curr").value;
  for (var i = 0; i < 4; i++) {
    document.getElementsByClassName("curry")[i].innerHTML = curr;
  }
  if (rgdbatt == "" || rgdbatt1 == "" || ngdpatt == "" || ngdpatt1 == "") {
  }else{
    $("#resulttable").css('display','');
    t = ngdpatt/rgdbatt;
    t1 = ngdpatt1/rgdbatt1;
    document.getElementById("bpresult").innerHTML = number_format(((t1-t)/t),2)*100 +"%";
  }
}
function inflcalfunctman(){
  inflcalfunct();
    var rgdbatt = document.getElementById("rgdbatt").value;
    var rgdbatt1 = document.getElementById("rgdbatt1").value;
    var ngdpatt = document.getElementById("ngdpatt").value;
...
function inflcalcreset() {
    document.getElementById('rgdbatt').value = "";
    document.getElementById('rgdbatt1').value = "";
    document.getElementById('ngdpatt').value = "";
    document.getElementById('ngdpatt1').value = "";
 	$("#resulttable").css('display','none');
 	$("#success").css('display','none');
  	$(".fail-func").css('display','none');
 	$("#reseted").css('display','');
}
function returnratecalc(file, delete_after = false) {
  var cpayment = document.getElementById("cpayment").value;
  var initpayment = document.getElementById("initpayment").value;
  var nextprice = document.getElementById("nextprice").value;
  var res = (+cpayment + +nextprice - +initpayment)/initpayment * 100;
  if (cpayment == "" || initpayment == "" || nextprice == "") {
  }else{
    $("#resulttable").css('display','');
    document.getElementById("rrresult").innerHTML = number_format(res,2) + "%";
  }
}
function returnratecalcman(){
  returnratecalc();
  var cpayment = document.getElementById("cpayment").value;
  var initpayment = document.getElementById("initpayment").value;
  var nextprice = document.getElementById("nextprice").value;
...
//
//   ga('create', 'UA-134368842-1', 'auto');
//   ga('send', 'pageview');
// }

function generateword(file, delete_after = false){
  var ws = document.getElementById("words").value.replace(/\s/g, '').toLowerCase();
  if ($("#length").val() == "0") {var ln  = 1;}else{var ln = $("#length").val();}
  var array = "";
  var list = ws.split(",");
  for (var i = 0; i < list.length; i++) {
    var ok = "";
    for (var a = 0; a < list[i].length; a++) {
      ok = list[i][a].substring(0, list[i].length);
    }
    array += "<tr><td>" + ok + "</td><td>" + ok + "</td></tr>";
  }
  document.getElementById("result").innerHTML = array;
}

function richtext_function(){
  var input = document.getElementById("tinymce");
  var output = document.getElementById("output");
  input.innerHTML = output.innerHTML;
}
function close_notify() {
  $(".notify-section").css('display','none').fadeOut();
}
...
if (window.location.href.match('/start-with-letter/') != null) {
   window.onload = function() {
      var urlPath = window.location.pathname.split("/");
      if (urlPath.length > 1) {
        var first_part = urlPath[3];
        findrelatedword(first_part);
      }
   };
}
function findrelatedword(part){
    if (document.getElementById("texthere").value != '') {
      if (part == null) {var txt = document.getElementById("texthere").value;}
      else{var txt = document.getElementById("texthere").value;}
      $("#nothing").css('display','none');
    }else{var txt = '0'; $("#nothing").css('display','');}
    var lang = document.getElementById("lang").value;
    if (document.getElementById('start').checked) {type = '0';}
    else if(document.getElementById('end').checked){type = '1';}
    if (document.getElementById("alllengths").checked) {
      var length = 0;
      document.getElementById('result-size').innerHTML = "--";
      document.getElementById('totallength').disabled = true;
    }else{
      document.getElementById('totallength').disabled = false;
      var length = document.getElementById('totallength').value;
      document.getElementById('result-size').innerHTML = length;
    }
    const Http = new XMLHttpRequest();
        const url = '/get-words/' + txt + '/' + type + '/' + lang + '/' + length;
        Http.open("GET", url);
        Http.send();
...
function getmeaning(take){
    if (take != null) {
      if (document.getElementById("entered_word").value != '') {
        var word = document.getElementById("entered_word").value.replace(/\//g, '');
      }else{var word = '0'}
    }else{var word = take}
    var lang = document.getElementById("lang").value;
     $("#sendmeaning, #success, #meaningedit").css('display','none');
     $("#meaning, #getmeaning, #editbtn").css('display','');
    const Http = new XMLHttpRequest();
        const url = '/get-meaning-of-terminology/' + word + '/' + lang;
        Http.open("GET", url);
        Http.send();
        Http.onreadystatechange=(e)=>{
          document.getElementById("meaning").innerHTML = Http.responseText;
        }
}
$('*').click(function(event) {
    if (this === event.target) {
        $(".auto-comp-tm").css('display','none');
    }
});
function select(thisObj){
   var link = thisObj.getAttribute("href");
   var take = thisObj.innerText;
   document.getElementById("entered_word").value = take;
   $(".auto-comp-tm").css('display','none');
   getmeaning(take);
}

function getsuggterm(){
  getmeaning();
  if (document.getElementById("entered_word").value != '') {
      var part = document.getElementById("entered_word").value.replace(/\//g, '');
    }else{var part = '0'}
  if (part.length > 2) {$(".auto-comp-tm").css('display','');}else{$(".auto-comp-tm").css('display','none');}
  const Http = new XMLHttpRequest();
        const url = '/get-suggestion-of-terminology/' + part + '/' + lang;
        Http.open("GET", url);
        Http.send();
        Http.onreadystatechange=(e)=>{
          document.getElementById("termsugg").innerHTML = Http.responseText;
        }
}
function changeeditable(){
     $("#meaning").css('display','none');
     $("#getmeaning").css('display','none');
     $("#sendmeaning").css('display','');
     $("#meaningedit").css('display','');
     console.log("working");
}

jQuery(document).ready(function(){
  jQuery('#sendmeaning').click(function(e){
    e.preventDefault();
    $.ajaxSetup({ headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')}});
    jQuery.ajax({
      url: "/add-meaning",
      method: 'POST',
      data: { mean: jQuery('#meaningedit').val(), word: jQuery('#entered_word').val(), lang: jQuery('#lang').val()},
...
$(document).ready(function(){
  if (getCookie("currency") !== "") {
    $("#curr option[value='"+getCookie("currency")+"']").prop("selected","selected");
    $("#currency").html("("+getCookie("currency")+")");
  }
  // console.log(getCookie("lang"));
});
$(document.body).on("change","#curr",function(){setCookie("currency",$(this).val(),1000);});

// $(".dlm > li > a").on("change",function(){
//   setCookie("lang",$(this).data("lang"),1000);
// });
